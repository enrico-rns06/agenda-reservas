...
const styles = {
  ...
  title: { fontSize: '1.5rem', fontWeight: '700', color: '#f1f1f1', marginBottom: '1.5rem' },
  grid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' },
  formCard: { backgroundColor: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: '16px', padding: '1.5rem' },
  form: { display: 'flex', flexDirection: 'column', gap: '1rem' },
  field: { display: 'flex', flexDirection: 'column', gap: '0.4rem' },
  row: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' },
  label: { fontSize: '0.85rem', color: '#888' },
  input: { padding: '0.75rem 1rem', backgroundColor: '#242424', border: '1px solid #2a2a2a', borderRadius: '10px', color: '#f1f1f1', fontSize: '0.95rem', outline: 'none' },
  selectedCard: { display: 'flex', alignItems: 'center', gap: '0.75rem', backgroundColor: '#242424', borderRadius: '10px', padding: '0.75rem' },
  ...
  selectedName: { fontSize: '0.95rem', fontWeight: '600', color: '#f1f1f1' },
  selectedEmail: { fontSize: '0.8rem', color: '#888' },
  ...
  listCard: { backgroundColor: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: '16px', padding: '1.5rem' },
  listTitle: { fontSize: '1rem', fontWeight: '600', color: '#f1f1f1', marginBottom: '1rem' },
  empty: { color: '#888', fontSize: '0.9rem' },
  bookingItem: { display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 0', borderBottom: '1px solid #2a2a2a' },
  ...
  bookingInfo: { flex: 1 },
  bookingName: { fontSize: '0.95rem', fontWeight: '600', color: '#f1f1f1' },
  bookingDetail: { fontSize: '0.8rem', color: '#888' },
